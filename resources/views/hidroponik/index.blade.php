                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <x-splade-table class="mt-4" :for="$hidroponiks" pagination-scroll="preserve">
                        <x-splade-cell actions as="$hidroponiks">
                            {{-- <Link href="{{ route('hidroponik.edit', $hidroponiks) }}" class="px-3 py-2 bg-yellow-500 rounded text-white hover:bg-yellow-300 hover:text-black font-semibold"> Ubah </Link> --}}
